...
const IndividualImage = (props) => {
    ...
    <div className='imgWrapper'>
        <IoIosArrowDropleftCircle size='45px' className='arrow arrowL' size="40" onClick={prevImg} />
        <IoIosArrowDroprightCircle size='45px' className='arrow arrowR' size="40" onClick={nextImg} />

        {
            imageList.map((img, index) => {
                
                return (
                    <div className={index === actual ? 'imgActiva' : 'slide'}>
